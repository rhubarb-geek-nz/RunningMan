...
Get-ChildItem "$HERE\disptlb\bin", "$HERE\bin" -File -Recurse | ForEach-Object {
	$EXE = $_.FullName
...
$Version = (Get-Item bin\x64\RhubarbGeekNzRunningMan.exe).VersionInfo.ProductVersion
$PackageId = 'rhubarb-geek-nz.RunningMan'
